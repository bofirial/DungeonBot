            ...
            return new AdventureState(new List<AdventureViewModel>()
            {
                new AdventureViewModel("Rat Infestation",
                    ...
                    new List<EncounterViewModel>()
                        {
                             new EncounterViewModel("Big Rat", "It's a rat with no friends.", "/images/temp/big-rat.png", EnemyType.Rat)
                        },
                    "Available",
                    null
                ),
                 ...
                 new AdventureViewModel("Rescue the Farmer's Sheep",
                    ...
                    new List<EncounterViewModel>()
                        {
                             new EncounterViewModel("Hungry Dragon Whelp", "He hasn't eaten.", "/images/temp/hungry-dragon.png", EnemyType.Dragon)
                        },
                    "Available",
                    null
                ),
                ...
                new AdventureViewModel("Skeleton Cave",
                    ...
                    new List<EncounterViewModel>()
                        {
                             new EncounterViewModel("Wolf King", "The wolf king waits inside the cave.", "/images/temp/wolf-king.png", EnemyType.Wolf)
                        },
                    "Available",
                    null
                )
