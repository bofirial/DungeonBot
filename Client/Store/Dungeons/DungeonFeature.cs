        ...
        protected override DungeonState GetInitialState()
        {
            return new DungeonState(new List<Dungeon>()
            {
                new Dungeon("Rat Infestation",
                    ...
                    new List<Encounter>()
                        {
                             new Encounter("Big Rat", "It's a rat with no friends.", "/images/temp/big-rat.png")
                        },
                    "Available",
                    null
                ),

                 new Dungeon("Rescue the Farmer's Sheep",
                    ...
                    new List<Encounter>()
                        {
                             new Encounter("Hungry Dragon Whelp", "He hasn't eaten.", "/images/temp/hungry-dragon.png")
                        },
                    "Available",
                    null
                ),

                new Dungeon("Skeleton Cave",
                    ...
                    new List<Encounter>()
                        {
                             new Encounter("Wolf King", "The wolf king waits inside the cave.", "/images/temp/wolf-king.png")
                        },
                    "Available",
                    null
                )
